...
from ..utils.efficiency_metrics import LERTracker, GSNRTracker
...
class IESCallback(TrainerCallback):
    ...
    def on_evaluate(self, args: TrainingArguments, state: TrainerState, control: TrainerControl,
        ...
        if "logits" in kwargs:
            ...
            self.ler_tracker.update(eval_loss, logits, accuracy)
    ...
    def on_init_end(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
        ...
        if "model" in kwargs:
            ...
            if self.enable_probe:
                ...
                from ..utils.efficiency_metrics import ProbeAccuracyTracker
